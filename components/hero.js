          ...
          <div className="max-w-2xl mb-8">
            <Typist cursor={{ show: false }}>
              <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
                Ace Your Frontend Interview and
              </h1>
              ...
              <h1 className="text-3xl font-bold leading-snug tracking-tight text-gray-800 lg:text-3xl lg:leading-tight xl:text-4xl xl:leading-tight dark:text-white">
                ...
                <span className="font-normal  text-custom-purple dark:text-gray-100">{'{- Get Your Dream Job -}'}</span>!
              </h1>
            </Typist>


            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              From Rejection to Recognition: Your Roadmap to Frontend Development Success! - Become a well-paid frontend developer and land the position you've dreamed of since you began learning frontend development.
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="px-8 py-4 text-lg font-medium text-center text-white bg-custom-purple rounded-md ">
                Grab Your Copy
              </a>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          ...
          <Marquee speed={20} pauseOnHover={true}>
            <div className="flex flex-wrap justify-center gap-20 mt-10 md:justify-around">
